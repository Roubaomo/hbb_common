...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "BryanmoJLC".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["home.rbtv.top:22226"];
pub const RS_PUB_KEY: &str = "+LBWrddjUrTEE9nG6sg2Q2zEZzimOFepvzuQxLwC1a8=";
